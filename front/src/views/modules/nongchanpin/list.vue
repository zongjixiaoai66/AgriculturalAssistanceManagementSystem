        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '所属仓库' : ''">
                        <el-select v-model="searchForm.cangkuTypes" placeholder="请选择所属仓库">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zhunongguanlixitong/upload/nongchanpinMuBan.xls"
                        >批量导入农产品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('nongchanpin','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="nongchanpinAddress"
                                   header-align="center"
                                   label="产出地">
                        <template slot-scope="scope">
                            {{scope.row.nongchanpinAddress}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="nongchanpinCaigouJine"
                                   header-align="center"
                                   label="采购价">
                        <template slot-scope="scope">
                            {{scope.row.nongchanpinCaigouJine}}
                        </template>
                    </el-table-column>

                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="nongchanpinNewJine"
                                   header-align="center"
                                   label="销售价">
                        <template slot-scope="scope">
                            {{scope.row.nongchanpinNewJine}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="cangkuTypes"
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                ...
                nongchanpinUuidNumber : null,
                nongchanpinPhoto : null,
                nongchanpinAddress : null,
                nongchanpinTypes : null,
                nongchanpinKucunNumber : null,
                nongchanpinCaigouJine : null,
                nongchanpinNewJine : null,
                cangkuTypes : null,
            ...
            json_fields: {
                //级联表字段
                     ...
                     '是否有额外收入': 'ewaishouruTypes',
                     '是否存在运输困难': 'yunshukunnanTypes',
                //本表字段
