...
public class GonggaoEntity<T> implements Serializable {
     ...
     * 助农政策名称
     */
    @ColumnInfo(comment="助农政策名称",type="varchar(200)")
     ...
     * 助农政策图片
     */
    @ColumnInfo(comment="助农政策图片",type="varchar(200)")
     ...
     * 助农政策类型
     */
    @ColumnInfo(comment="助农政策类型",type="int(11)")
	...
	@DateTimeFormat
    @ColumnInfo(comment="助农政策发布时间",type="timestamp")
     ...
     * 助农政策详情
     */
    @ColumnInfo(comment="助农政策详情",type="text")
