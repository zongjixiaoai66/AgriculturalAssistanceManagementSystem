...
var centerMenu = [
    ...
    ,{
        name: '农产品',
        url: '../nongchanpin/list.html'
    }
    ,{
        name: '农产品售卖',
        url: '../nongchanpinXiaoshou/list.html'
    }
